		...
		<div id='header_meta' class='container_wrap container_wrap_meta <?php echo avia_header_class_string(array('header_social', 'header_secondary_menu', 'header_phone_active'), 'av_'); ?>'>
			      ...
			      <?php
                      ...
                      <div class="top-menu">
                            <div class="menu-link">
                      <?php
							echo "<nav class='_sub_menu' ".avia_markup_helper(array('context' => 'nav', 'echo' => false)).">";
							echo $nav;
				 ...
				 <div class='container abc'>
					...
					<div class='inner-container'>
						...
						*/
						    ...
						    echo "<nav class='main_menu' id='main-menu' data-selectname='".__('Select a page','avia_framework')."' ".avia_markup_helper(array('context' => 'nav', 'echo' => false)).">";
						        $avia_theme_location = 'avia';
						        $avia_menu_class = $avia_theme_location . '-menu_ mm-container';
						        $args = array(
						            'theme_location'	=> $avia_theme_location,
						            'menu_id' 			=> $avia_menu_class,
						            'menu_class'		=> '_menu _av-main-nav',
