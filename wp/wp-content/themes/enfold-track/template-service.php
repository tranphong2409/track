...
//            get_sidebar();
    ...
    <div id="quotes"
         class="avia-section main_color avia-section-large avia-no-border-styling avia-bg-style-fixed avia-full-stretch  avia-builder-el-12  el_after_av_section  el_before_av_section   container_wrap fullsize"
         style="background-repeat: no-repeat; background-image: url(/wp-content/uploads/2017/06/AAEAAQAAAAAAAAeKAAAAJGRjMGU2YzQxLTNkOTctNDc1My04MTg3LWY3OWM2MWQ5NDM2MA-1500x430.jpg); background-attachment: fixed; background-position: top center; "
         data-section-bg-repeat="stretch">
        <div class="container">
            <div class="template-page content  av-content-full alpha units">
                <div class="post-entry post-entry-type-page post-entry-130">
                    <div class="entry-content-wrapper clearfix">
                        <div style="padding-bottom:20px;"
                             class="av-special-heading av-special-heading-h2 custom-color-heading blockquote modern-quote  avia-builder-el-13  el_before_av_textblock  avia-builder-el-first  color-underline">
                            <h2 class="av-special-heading-tag" itemprop="headline"><?php _e("REQUEST A QUOTES");?></h2>
                        ...
                        <section class="av_textblock_section" itemscope="itemscope"
                            ...
                            <div class="avia_textblock  av_inherit_color" itemprop="text"><p style="text-align: left;">
                                   <?php _e("quotes-desc");?></p>
                            </div>
                        </section>
                        <div style="height:20px"
                             class="hr hr-invisible  avia-builder-el-15  el_after_av_textblock  el_before_av_codeblock  ">
                            <span class="hr-inner "><span class="hr-inner-style"></span></span></div>
                        <section>
                            <div class="quote"><?php echo do_shortcode("[quote_box]"); ?></div>
                        </section>
                        <p></p>
                    </div>
                </div>
